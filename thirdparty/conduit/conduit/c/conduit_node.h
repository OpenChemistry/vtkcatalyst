...
CONDUIT_C_API char* conduit_node_to_json(const conduit_node *cnode);
// the caller must free the result
CONDUIT_C_API char* conduit_node_to_json_with_options(const conduit_node *cnode,
                                                    const conduit_node *copts);

// the caller must free the result
CONDUIT_C_API char* conduit_node_to_yaml(const conduit_node *cnode);
// the caller must free the result
CONDUIT_C_API char* conduit_node_to_yaml_with_options(const conduit_node *cnode,
                                                    const conduit_node *copts);

// the caller must free the result
CONDUIT_C_API char* conduit_node_to_string(const conduit_node *cnode);
// the caller must free the result
CONDUIT_C_API char* conduit_node_to_string_with_options(const conduit_node *cnode,
                                                      const conduit_node *copts);

// the caller must free the result
CONDUIT_C_API char* conduit_node_to_summary_string(const conduit_node *cnode);
// the caller must free the result
CONDUIT_C_API char* conduit_node_to_summary_string_with_options(const conduit_node *cnode,
                                                              const conduit_node *copts);
