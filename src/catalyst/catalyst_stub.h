...
inline enum catalyst_status catalyst_stub_initialize(const conduit_node* params)
{
  dump_node(params, "initialize", 0, false);
  return catalyst_status_ok;
}

inline enum catalyst_status catalyst_stub_finalize(const conduit_node* params)
{
  dump_node(params, "finalize", 0, false);
  return catalyst_status_ok;
}

inline enum catalyst_status catalyst_stub_execute(const conduit_node* params)
{
...
inline enum catalyst_status catalyst_stub_about(conduit_node* params)
{
...
inline enum catalyst_status catalyst_stub_results(conduit_node* params)
{
  return catalyst_status_ok;
}
